...
public class test {
    ...
    public static void main(String[] args) throws IOException, ClassHierarchyException, IllegalArgumentException,
        ...
        AnalysisScope scope = AnalysisScopeReader.readJavaScope(scopeFile, null, test.class.getClassLoader());
        ...
        String methodSig = "helloworld.main([Ljava/lang/String;)V";
        ...
        //AnalysisCache cache = new AnalysisCache(m,options.getSSAOptions(), );
        IR ir = cache.getSSACache().findOrCreateIR(m, Everywhere.EVERYWHERE, options.getSSAOptions());
        System.out.println("the IR is: ");
